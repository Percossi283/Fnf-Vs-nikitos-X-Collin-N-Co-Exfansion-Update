...
class GalleryScreenState extends MusicBeatState
{
    ...
    override public function create():Void
    {
        ...
        imagePaths = ["DIE RUBI", "You Will D I E", "gamble guy but my style"];
        imageDescriptions = ["Welp Got? NOU NOU NOUUU :(.", "!", "Gamble guy but my style!"];
        imageTitle = ["Ruby Gets Grounded by Burning Eros House", "No (Made by Eros)", "Weeekly? (btw!)"];
