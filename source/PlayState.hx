...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Well Undone', 0.4], //From 20% to 39%
		['Damn?!?!', 0.5], //From 40% to 49%
		['Are you Stupid?!?!', 0.6], //From 50% to 59%
		['Um', 0.69], //From 60% to 68%
		['Well Done', 0.7], //69%
		['Nice', 0.8], //From 70% to 79%
		['nice Kid', 0.9], //From 80% to 89%
		['Good!', 1], //From 90% to 99%
		['Nikitos And Collin Is Happy!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
